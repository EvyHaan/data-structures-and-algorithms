...
describe('Testing challenge 1', () => {
  test.skip('It should sort high-to-low the numbers in an array', () => {
...
describe('Testing challenge 2', () => {
  test.skip('It should sort strings alphabetically', () => {
...
describe('Testing challenge 4', () => {
  test.skip('It should alphabetize without regard to capitalization', () => {
...
describe('Testing challenge 5', () => {
  test.skip('It should sort items by their price', () => {
    expect(sortByPrice([
      {name: 'Sweatshirt', price: 45},
      {name: 'Bookmark', price: 2.50},
      {name: 'Tote bag', price: 15}
...
describe('Testing challenge 6', () => {
  test.skip('It should sort numbers by their length', () => {
...
describe('Testing challenge 7', () => {
  test.skip('It should sort people by their last names', () => {
...
describe('Testing challenge 9', () => {
  test.skip('It should sort meetings by the day on which they happen', () => {
...
describe('Testing challenge 10', () => {
  test.skip('It should sort meetings by when they happen', () => {
