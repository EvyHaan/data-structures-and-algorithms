...
const getStatName = (arr, minBaseStat) => {
    const newArr = arr.filter( val => (minBaseStat < val.baseStat));
    let newArr2 = newArr.map( val => val.stat.name);
    return newArr2
};
...
describe('Testing challenge 6', () => {
  test.skip('It should return an array containing characters who do not have children', () => {
...
describe('Testing challenge 7', () => {
  test.skip('It should remove non-integers and return "even" or "odd', () => {
  ...
  test.skip('It should not accept strings that look like numbers', () => {
