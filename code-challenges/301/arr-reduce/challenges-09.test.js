...
describe('Testing challenge 5', () => {
  test.skip('It should return the average of the numbers in the array', () => {
    expect(calculateAverage([18, 290, 37, 4, 55, 16, 7, 85 ])).toStrictEqual(64);
  });
});

describe('Testing challenge 6', () => {
  test.skip('It should return a count of the prime numbers in the array', () => {
    expect(countPrimeNumbers([1, 2, 13, 64, 45, 56, 17, 8])).toStrictEqual(3);
  });
});

describe('Testing challenge 7', () => {
  test.skip('It should return any stats that match the input', () => {
...
describe('Testing challenge 8', () => {
  test.skip('It should return an array containing the names of the children', () => {
