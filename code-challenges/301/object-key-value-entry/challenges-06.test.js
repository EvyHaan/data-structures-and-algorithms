...
const totalCharacters = (arr) => {
    let charactortotal = arr.length;
    return charactortotal;
}
...
const hasChildrenValues = (arr, character) => {
  for ( let i in arr) {
    if ( arr[i].name === character) {
      let kiddos = Object.values(arr[i].children);
        if (kiddos.length < 1) {
      console.log(kiddos)
          return false
        } else {
...
const hasChildrenEntries = (arr, character) => {
  for ( let i in arr) {
    if ( arr[i].name === character) {
      let kiddos = Object.entries(arr[i])[2];
        console.log(kiddos)
        if (kiddos[1].length === 0) {
          return false
        } else {
          return true
        }
...
describe('Testing challenge 6', () => {
  test.skip('It should return an object for each house containing the name and size', () => {
...
describe('Testing challenge 7', () => {
  test.skip('It should not include any deceased spouses', () => {
