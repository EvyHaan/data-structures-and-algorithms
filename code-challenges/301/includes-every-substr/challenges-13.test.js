...
const standardizePhoneNumbers = (arr) => {
  let yoNumba = [];
  arr.forEach( number => {
    yoNumba.push(number.substr(1,3) + number.substr(6,3) + number.substr(10,4))
  })
...
describe('Testing challenge 8', () => {
  test.skip('It should remove Brook from all courses', () => {
    const roster = [
...
describe('Testing challenge 9', () => {
  test.skip('It should sort events by the day on which they happen', () => {
...
describe('Testing challenge 10', () => {
  test.skip('It should return the ith character of the ith string', () => {
    const words = ['apple', 'banana', 'cantaloupe'];
