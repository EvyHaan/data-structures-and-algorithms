...
const gruffaloCrumble = {
  ...
  ingredients: [
    '1 medium-sized Gruffalo', // ['1', 'medium-sized', 'Gruffalo']
    '8 pounds oats',
...
const listFoods = (recipe) => {
  ...
  for (let i = 0 ; i < recipe.ingredients.length; i++){
    ...
    result.push(recipe.ingredients[i].slice(secondSpaceIndex + 1));
  }
  return result;
}
...
describe('Testing challenge 5', () => {
  test.skip('It should return a list of recipe steps', () => {
...
describe('Testing challenge 6', () => {
  test.skip('It should remove the even numbers from the array', () => {
...
describe('Testing challenge 7', () => {
  test.skip('It should shorten the string based on the first argument', () => {
    expect(removeLastCharacters('Gregor', 2)).toStrictEqual('Greg');
    expect(removeLastCharacters('Gregor', 2).length).toStrictEqual(4);
  });
  test.skip('It should return the complete string when passed a negative number', () => {
    expect(removeLastCharacters('hello', -1)).toStrictEqual('hello');
    expect(removeLastCharacters('wowow', -700)).toStrictEqual('wowow');
  });
  test.skip('It should return an empty string when called with a number larger than the string length', () => {
...
describe('Testing challenge 8', () => {
  test.skip('It should add up the numbers contained within the string', () => {
...
describe('Testing challenge 9', () => {
  test.skip('It should return the string without vowels', () => {
