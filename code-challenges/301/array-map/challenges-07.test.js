...
describe('Testing challenge 6', () => {
  test.skip('It should return an array containing only the ability names', () => {
...
describe('Testing challenge 7', () => {
  test.skip('It should return an array containing objects with name and total values', () => {
